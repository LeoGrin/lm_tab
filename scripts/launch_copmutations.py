...
executor.update_parameters(timeout_min=100, slurm_partition='parietal,normal', slurm_array_parallelism=20, cpus_per_task=2,
                            exclude="margpu009")
# change name of job
